...
namespace KDTB_FORMS
{
    public partial class MM_MaterialInput : DC00_WinForm.BaseMDIChildForm
    {
        ...
        private void MM_MaterialInput_Load(object sender, EventArgs e)
        {
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "INPUTSEQ" ,    "입고번호",     GridColDataType_emu.VarChar        , 130, HAlign.Left , true, false);
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "WO"   ,        "발주장소",     GridColDataType_emu.VarChar,          60, HAlign.Center,true, true);
