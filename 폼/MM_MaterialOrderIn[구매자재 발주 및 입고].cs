    ...
    public partial class MM_MaterialOrderIn : DC00_WinForm.BaseMDIChildForm
    {
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                DataTable dtTemp = new DataTable();
                dtTemp = helper.FillTable("_1JO_MM_MaterialOrderIn_S1", CommandType.StoredProcedure
                ...
                foreach (DataRow row in dt.Rows)
                {
                    switch (row.RowState)
                    {
                        ...
                        case DataRowState.Modified:
                            // 입고 등록을 하겠다! 라는 말
                            helper.ExecuteNoneQuery("SP07_MM_MaterialOrderIn_U1", CommandType.StoredProcedure,
                                                    helper.CreateParameter("@PLANTCODE", Convert.ToString(row["PLANTCODE"])),
                                                    helper.CreateParameter("@PONO"     , Convert.ToString(row["PONO"])),
